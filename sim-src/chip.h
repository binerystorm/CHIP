...
//#define Gen_Color(R, G, B) (Type){R, G, B}  
...
void V2f_lerp(const V2f const *v1, V2f *v2, float co);
void lerp_update(const V2f const *target, Section *sec, float co);
void sec_fill(Section *sec);
void sec_clear(Section *sec);
void sec_lerp_update(const V2f const *target, Section *sec, float co);
